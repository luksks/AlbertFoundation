    ...
    <div class="bg-background-tertiary">
        ...
        <div class="alert-banner">
            <label class="close cursor-pointer  items-center " title="close" for="banneralerte">
                <input type="checkbox" class="hidden" id="banneralerte">
                <div role=" alert ">
                    <div class=" mx-4 py-2">
                        ...
                        <div class="border items-center justify-between flex border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-2 text-red-700">
                            ...
                            <div class="  flex  justify-end">
                                <div class="text-center text-red-700 p-2 bg-red-500 items-center leading-none lg:rounded-full flex lg:inline-flex"
                                    ...
                                    <nuxt-link to="/privacy" class="cursor-pointer flex rounded-full bg-red-100 uppercase px-2 py-1 text-xs font-bold mr-3"
                                           >READ OUR PRIVACY POLICY </nuxt-link>
