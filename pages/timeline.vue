<template>
        ...
        <div class="bg-background-tertiary max-w-lg mx-auto my-8 border border-border-color-primary overflow-hidden rounded-t-lg w-full">
            <div class="flex flex-wrap no-underline text-copy-primary h-64 overflow-hidden">
                <div class="w-3/4 h-full">
                    <img class="block pr-px w-full h-full" src="../assets/img/timeline/BTS_main_illustration.jpg" alt=""
                         style="object-fit: cover;">
                </div>
                <div class="w-1/4 h-full">
                    <div class="bg-pink-200 mb-px h-32">
                       <img class="block w-full h-full" src="../assets/img/timeline/BTS_second_illustration.jpg" alt=""
                            style="object-fit: cover;">
                    </div>
                    <div class="bg-pink-200 h-32">
                        <img class="block w-full h-full" src="../assets/img/timeline/BTS_tertiary_illustration.jpg" alt=""
                             style="object-fit: cover;">
                    </div>
                </div>
            </div>
            <div class="p-4 text-copy-primary">
                ...
                <p class="leading-normal mb-4 text-copy-secondary">
                    At Hight School Paul Cornu (14100) Lisieux. IT science (algorithmic) and math/physics. I also have one internship (bottom square).</p>
    <div class="pl-2 pr-2 border-t border-border-color-primary mx-6">
    <p class="font-medium text-lg text-copy-primary mt-4">Professional project of the diploma.</p>
    <div class="text-xs text-copy-secondary flex items-center my-1 pl-4 ">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
             class="h-4 w-4 mr-1 feather feather-calendar stroke-current text-copy-primary">
    ...
    <p class="leading-normal mb-4 text-copy-secondary"> Creation of a intern gestion website for a compagnie.
        The system is provided with a database, VPN. My work is on the site design. <br> <br>
        </p>
...
<!--            ==============================   PROTOTYPE COMMENTAIRE SERVEUR =========================================-->
            ...
            <div class="bg-grey-lighter p-4 pl-8 text-copy-primary" v-show="!isNinja">
                <textarea class="px-2 w-full border border-blue rounded hover:bg-background-primary bg-background-tertiary italic font-mono
                                 focus:outline-none focus:shadow-outline" laceholder="Create a post..." id="create-post" v-model="text"></textarea>
...
<!--        internship + navy diploma    -->
        <div class="bg-background-tertiary max-w-lg mx-auto my-8 border border-border-color-primary overflow-hidden w-full">
            <div class="flex flex-wrap no-underline text-copy-primary h-64 overflow-hidden">
                <div class="w-3/4 h-full">
                    <img class="block pr-px w-full h-full" src="../assets/img/timeline/BAC_main_illustration.jpg" alt=""
                         style="object-fit: cover;">
                </div>
                <div class="w-1/4 h-full">
                    <div class="bg-pink-200 mb-px h-32">
                        <img class="block w-full h-full" src="../assets/img/timeline/BAC_second_illustration.jpg" alt=""
                             style="object-fit: cover;">
                    </div>
                    <div class="bg-pink-200 h-32">
                        <img class="block w-full h-full object-left" src="../assets/img/timeline/BAC_tertiary_illustration.jpg" alt=""
                             style="object-fit: cover;">
                    </div>
                </div>
            </div>
        ...
        <div class="bg-background-tertiary max-w-lg mx-auto my-8 border border-border-color-primary overflow-hidden w-full">
            ...
            <div class="flex flex-wrap no-underline text-copy-primary h-64 overflow-hidden">
                <div class="w-3/4 h-full">
                    <img class="block pr-px w-full h-full" src="../assets/img/timeline/Navy_main_illustration.jpg" alt=""
                         style="object-fit: cover;">
                </div>
                <div class="w-1/4 h-full">
                    <div class="bg-pink-200 mb-px h-32">
                        <img class="block w-full h-full object-left" src="../assets/img/timeline/Navy_second_illustration.jpg" alt=""
                             style="object-fit: cover; ">
                    </div>
                    <div class="bg-pink-200 h-32">
                        <img class="block w-full h-full object-right" src="../assets/img/timeline/Navy_tertiary_illustration.jpg" alt=""
                             style="object-fit: cover;">
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 text-copy-primary">
                <h2 class="font-medium text-lg mb-2">Internship - MARINE NATIONALE, Saint Mandrier (83430)</h2>
                <div class="text-xs text-copy-secondary flex items-center my-1 pl-4 ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="h-4 w-4 mr-1 feather feather-calendar stroke-current text-copy-primary">
                ...
                <p class="leading-normal mb-4 text-copy-secondary text-justify">
                    ...
                    as a network technician. I'm on the middle on the main picture, the picture of right are the Cassard.
                </p>
            </div>
            <footer class=" text-sm flex pb-6">
                <div class="w-32 ">
