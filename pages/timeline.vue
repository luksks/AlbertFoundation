...
<!--            ==============================   PROTOTYPE COMMENTAIRE SERVEUR =========================================-->
                ...
                <div class="posts-container">
                    <div class="post w-full"
                        ...
                        <button class="w-full text-copy-primary border border-border-color-primary text-lg">
                            <p>{{product.text}}</p>
                            <p class="text-color-secondary text-xs"> {{product.createdAt}}</p>
                        </button>
...
<!--            =======================   FORMATAGE FINAL DES MSG DE LA BDD SOUS CE MODELE =============-->
